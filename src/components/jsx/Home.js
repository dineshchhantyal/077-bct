...
const Home = () => {
    return (
        <Container>
            <Header>BCT-077 AB Portal</Header>
            <Navigator>
                <Link to="/video"><NavIcon src={videoImage} alt="" /></Link>
                <Link to="/notes"><NavIcon src={notesImage} alt="" /> </Link>
                <Link to="/student"><NavIcon src={stdImage} alt="" /> </Link>
                <Link to="/admin"><NavIcon src={adminImage} alt="" /> </Link>
            </Navigator>
        </Container >
    )
}
